...
@section('page_content')
	...
	<!-- Gallery -->
	<div class="section-gallery p-t-118 p-b-50 bg1-pattern">
		...
		<div class="wrap-gallery isotope-grid flex-w p-l-25 p-r-25">
			...
			<div class="item-gallery isotope-item bo-rad-10 hov-img-zoom events guests">
				...
				<div class="overlay-item-gallery trans-0-4 flex-c-m">
					<a class="btn-show-gallery flex-c-m" href="images/photo-gallery-13.jpg" data-lightbox="gallery">
			...
			<div class="item-gallery isotope-item bo-rad-10 hov-img-zoom food">
				...
				<div class="overlay-item-gallery trans-0-4 flex-c-m">
					<a class="btn-show-gallery flex-c-m " href="images/photo-gallery-14.jpg" data-lightbox="gallery">
						<i class="fa fa-search"></i>
					</a>
				</div>
			</div>
			...
			<div class="item-gallery isotope-item bo-rad-10 hov-img-zoom events">
				...
				<div class="overlay-item-gallery trans-0-4 flex-c-m">
					<a class="btn-show-gallery flex-c-m" href="images/photo-gallery-15.jpg" data-lightbox="gallery">
						<i class="fa fa-search"></i>
					</a>
				</div>
			</div>
			...
			<div class="item-gallery isotope-item bo-rad-10 hov-img-zoom food">
				...
				<div class="overlay-item-gallery trans-0-4 flex-c-m">
					<a class="btn-show-gallery flex-c-m" href="images/photo-gallery-16.jpg" data-lightbox="gallery">
						<i class="fa fa-search"></i>
					</a>
				</div>
			</div>
			...
			<div class="item-gallery isotope-item bo-rad-10 hov-img-zoom food">
				...
				<div class="overlay-item-gallery trans-0-4 flex-c-m">
					<a class="btn-show-gallery flex-c-m" href="images/photo-gallery-17.jpg" data-lightbox="gallery">
						<i class="fa fa-search"></i>
					</a>
				</div>
			</div>
			...
			<div class="item-gallery isotope-item bo-rad-10 hov-img-zoom interior guests">
				...
				<div class="overlay-item-gallery trans-0-4 flex-c-m">
					<a class="btn-show-gallery flex-c-m" href="images/photo-gallery-18.jpg" data-lightbox="gallery">
						<i class="fa fa-search"></i>
					</a>
				</div>
			</div>
			...
			<div class="item-gallery isotope-item bo-rad-10 hov-img-zoom interior">
				...
				<div class="overlay-item-gallery trans-0-4 flex-c-m">
					<a class="btn-show-gallery flex-c-m" href="images/photo-gallery-19.jpg" data-lightbox="gallery">
						<i class="fa fa-search"></i>
					</a>
				</div>
			</div>
			...
			<div class="item-gallery isotope-item bo-rad-10 hov-img-zoom interior">
				...
				<div class="overlay-item-gallery trans-0-4 flex-c-m">
					<a class="btn-show-gallery flex-c-m" href="images/photo-gallery-20.jpg" data-lightbox="gallery">
						<i class="fa fa-search"></i>
					</a>
				</div>
			</div>
			...
			<div class="item-gallery isotope-item bo-rad-10 hov-img-zoom events">
				...
				<div class="overlay-item-gallery trans-0-4 flex-c-m">
					<a class="btn-show-gallery flex-c-m" href="images/photo-gallery-21.jpg" data-lightbox="gallery">
						<i class="fa fa-search"></i>
					</a>
				</div>
			</div>
